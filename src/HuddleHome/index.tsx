...
const HuddleHome = () => {
    return (
        <div className="flex min-h-screen w-screen flex-col items-center gap-6 bg-[var(--huddle-primary)] font-['Poppins'] text-white ">
            <div
                className={`flex min-h-screen w-full items-center gap-12 bg-cover
bg-no-repeat px-8
calculator-app-mobile:flex-col
calculator-app-mobile:bg-[url('/images/huddle/bg-mobile.svg')]
            ...
            >
                ...
                <div className="flex flex-col items-center gap-6   calculator-app-desktop:flex-row">
                    ...
                    <div className="flex flex-col gap-6 calculator-app-mobile:items-center calculator-app-desktop:items-start">
                        <h3 className="text-xl font-semibold calculator-app-mobile:text-center">
                            Build The Community
                            <br />
                            Your Fans Will Love
                        </h3>
                        ...
                        <button className="shadow-[var(--huddle-primary) ]  w-[200px] rounded-3xl bg-white py-4 text-center text-[var(--huddle-primary)] shadow-lg">
                            Register
                        </button>
                    </div>
                </div>
